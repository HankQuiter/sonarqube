...
public class OrganizationRule extends ExternalResource implements OrganizationSupport {
  ...
  protected void before() {
    enableSupport();
    rootSupport = new OrganizationSupportImpl(ItUtils.newAdminWsClient(orchestrator));
  }
  ...
  @Override
  public Organizations.Organization create(Consumer<CreateWsRequest.Builder>... populators) {
    return rootSupport.create();
  }

  @Override
  public OrganizationSupport assertThatOrganizationDoesNotExist(String organizationKey) {
    return rootSupport.assertThatOrganizationDoesNotExist(organizationKey);
  }
  ...
  private static class OrganizationSupportImpl implements OrganizationSupport {
    ...
    public OrganizationSupportImpl(WsClient wsClient) {
